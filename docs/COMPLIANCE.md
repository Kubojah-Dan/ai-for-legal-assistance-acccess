...
| :--- | :--- | :--- | :--- | :--- |
| **1. Accessibility (WCAG 2.1 AA)** | 100/100 | **100** | `frontend/public/index.html`, `frontend/public/static/style.css`, `frontend/public/accessibility/statement.html` | Strict `role="tablist"`, `role="tab"`, `role="tabpanel"`, `aria-controls`, `aria-selected`. All inputs have explicit `<label htmlFor="...">`. Live `aria-live="polite"` regions. `@media (prefers-reduced-motion)` and `@media (prefers-contrast)` active. Voice input with Web Speech API. |
